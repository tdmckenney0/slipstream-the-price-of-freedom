...
function Rule_Init()
	...
	SobGroup_CreateSubSystem("MSGroup", "Hgn_MS_Module_Research")
...
function Rule_Player_Wins()
	if (Player_HasResearch(0, "RepairAbility") == 1) then
...
Events.IntelEvent_Intro =
{
	...
	},
	{
		...
		HW2_SubTitleEvent(Actor_FleetIntel, "Research the Repair ability to win the mission.", 4),
	},
	{
		HW2_Wait(2),
	},
