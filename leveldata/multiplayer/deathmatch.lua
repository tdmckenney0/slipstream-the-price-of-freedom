...
-- 5/20/2008 11:22:26 PM
-- LuaDC by Age2uN
-- on error send source file (compiled lua) and this outputfile to Age2uN@gmx.net
--
GUID = 
    { 110, 91, 157, 190, 18, 23, 250, 78, 144, 20, 41, 246, 181, 128, 214, 12, }
GameRulesName = "TPOF: Mac OS X"
Description = "These Rules are for Playing without Tpof's Special Features. This is for The Mac Os X version of the game, and for people with lower Technical Specifications."
GameSetupOptions = 
    { 
    { 
        name = "resources", 
    ...
    { 
        ...
        visible = 1, 
        choices = 
            { "$3215", "Small", "$3216", "Normal", "$3217", "Large", "Very High", "unlimited", }, }, 
    { 
        name = "resstart", 
        locName = "$3205", 
        tooltip = "$3232", 
