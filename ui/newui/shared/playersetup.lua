		...
		},
		{
			...
			ListBox =
			{
				...
				;
				{
					...
					onMouseClicked = [[UI_SetElementVisible("PlayerSetup", "shippreview", 1); UI_SetElementVisible("PlayerSetup", "vshippreview", 0);]],
				},
				{
					type = "TextListBoxItem",
					buttonStyle = "FEListBoxItemButtonStyle",
					...
					onMouseClicked = [[UI_SetElementVisible("PlayerSetup", "shippreview", 0); UI_SetElementVisible("PlayerSetup", "vshippreview", 1);]],
				},
			},
			helpTipTextLabel = "helpTip",
			helpTip = "$2792",
		...
		},
		{
			...
			;
			{
				...
				BackgroundGraphic =
				{
					...
					texture = "DATA:UI\\NewUI\\PlayerSetup\\arrowup.tga",
					textureUV =
					{
						0,
						0,
