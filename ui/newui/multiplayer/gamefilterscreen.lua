...
{ 
    ...
    { 
        ...
        text = "$2613", }, 
    onMouseClicked = [[UI_SetScreenVisible("GameFilterScreen", 0);]], 
    helpTipTextLabel = "helpTip", 
    helpTip = "$2613", 
}, 
{ 
