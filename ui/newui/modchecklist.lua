...
{
	{
		...
		creditsText = [[Main Programmer and "CEO" of SRI. Built the Mod from the ground up. Designed new main menu, and most of the base systems.]],
	...
	},
	{
		...
		creditsText = [[Weapons, and Ships. Original Battlebarge designer and engineer. EMP Weapons, Modified Ion and laser weapons. DOL Helios Designer.]],
		creditsToolTip = [[Weapons/Ship Engineer]],
		creditsImage = [[Data:UI\CreditsPics\SRI_Corp.tga]],
	},
	{
		creditsName = [[DoubleForte]],
		creditsText = [[Photoshop. Slipstream Fractal Creator. Assisted in making things look prettier.]],
		creditsToolTip = [[Photoshopper]],
		creditsImage = [[Data:UI\CreditsPics\SRI_Corp.tga]],
	},
	{
		creditsName = [[NSWMaps]],
		creditsText = [[Created Many of the new maps seen in TPOF. Majorly helped with TPOF Bugfixing. Kudos for getting tpof to work on the Mac.]],
		creditsToolTip = [[Main Map Engineer]],
		creditsImage = [[Data:UI\CreditsPics\SRI_Corp.tga]],
	},
	{
		creditsName = [[Mikail]],
		creditsText = [[Makail Created many Tweak for Homeworld 2 that help TPOF along. His Music Scripts, and Gameplay tweaks, along with this credit screen, helped a ton. Thanks Man.]],
		creditsToolTip = [[Mikail]],
		creditsImage = [[Data:UI\MapThumbnails\Campaign\Default.tga]],
	},
	{
		creditsName = [[Axel]],
		creditsText = [[Axels models and Base Weapons Helped a lot in the layout of the Slipstream Universe. Thanks Man.]],
		creditsToolTip = [[Axel]],
		creditsImage = [[Data:UI\MapThumbnails\Campaign\Default.tga]],
	},
	{
	...
	{
		creditsName = [[Steph]],
		creditsText = [[For Steph\nFor None of this would have been.\n\n-- SRI-Emperor]],
		creditsToolTip = [[Stephanie]],
		creditsImage = [[Data:UI\CreditsPics\SRI_corp.tga]],
	},
}