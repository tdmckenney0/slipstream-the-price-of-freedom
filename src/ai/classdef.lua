...
squadclass[eBuilder] = {
    HGN_MOTHERSHIP, HGN_SHIPYARD, HGN_BATTLECRUISER, HGN_HEAVYBATTLECRUISER,
    VGR_MOTHERSHIP, VGR_MOTHERSHIP_MAKAAN, VGR_SHIPYARD, VGR_BATTLECRUISER, VGR_QWAARJETII,
}

-- Drop-off Points for Resources
squadclass[eDropOff] = {
    HGN_MOTHERSHIP, HGN_SHIPYARD, HGN_RESOURCECONTROLLER,
    VGR_MOTHERSHIP, VGR_MOTHERSHIP_MAKAAN, VGR_SHIPYARD, VGR_RESOURCECONTROLLER,
}

-- Salvage Drop-off Points
squadclass[eSalvageDropOff] = {
    HGN_MOTHERSHIP, HGN_SHIPYARD,
    VGR_MOTHERSHIP, VGR_MOTHERSHIP_MAKAAN, VGR_SHIPYARD,
}
...
-- NOTE: HGN gun/ion turrets and VGR weapon platforms were removed from TPOF
-- after v4.0 (and are restricted), leaving only the hyperspace platform here.
...
squadclass[eAntiFighter] = {
    HGN_INTERCEPTOR, HGN_ASSAULTCORVETTE, HGN_ASSAULTFRIGATE,
    VGR_INTERCEPTOR, VGR_ASSAULTFRIGATE,
}
...
squadclass[eAntiFrigate] = {
    HGN_ATTACKBOMBER, HGN_ATTACKBOMBERELITE, HGN_IONCANNONFRIGATE,
    ...
    VGR_DESTROYER, VGR_BATTLECRUISER, VGR_QWAARJETII, VGR_VANAARJET,
    SRI_DREADNAUGHT, SRI_SAJUUK,
}

-- Capital Ships - SLIPSTREAM: Heavy Battlecruisers are the workhorse capital ships
squadclass[eCapital] = {
    HGN_MOTHERSHIP, HGN_SHIPYARD, HGN_DESTROYER,
    HGN_BATTLECRUISER, HGN_HEAVYBATTLECRUISER,
    VGR_MOTHERSHIP, VGR_MOTHERSHIP_MAKAAN, VGR_SHIPYARD,
    VGR_DESTROYER, VGR_BATTLECRUISER, VGR_QWAARJETII, VGR_VANAARJET,
    SRI_DREADNAUGHT, SRI_SAJUUK,
}
...
squadclass[eHeavyBattleCruiser] = {
    HGN_HEAVYBATTLECRUISER, VGR_QWAARJETII,
}
