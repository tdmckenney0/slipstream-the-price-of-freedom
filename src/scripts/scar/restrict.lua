...
function RestrictOptions(playerid)
    ...
    if  playerRace==Race_Hiigaran then
        ...
        Player_RestrictBuildOption(playerid, "Hgn_Carrier")
        Player_RestrictBuildOption(playerid, "Hgn_C_Module_Research")
        Player_RestrictBuildOption(playerid, "Hgn_MS_Module_Research")
        Player_RestrictBuildOption(playerid, "Hgn_C_Module_ResearchAdvanced")
        Player_RestrictBuildOption(playerid, "Hgn_MS_Module_ResearchAdvanced")
        ...
        Player_RestrictResearchOption(playerid, "DestroyerTech")
        Player_RestrictResearchOption(playerid, "BattlecruiserIonWeapons")
        Player_RestrictResearchOption(playerid, "PlatformIonWeapons")
        Player_RestrictResearchOption(playerid, "CarrierHealthUpgrade1")
        Player_RestrictResearchOption(playerid, "CarrierMAXSPEEDUpgrade1")
        Player_RestrictResearchOption(playerid, "CarrierBUILDSPEEDUpgrade1")
        Player_RestrictResearchOption(playerid, "GunTurretHealthUpgrade1")
    end 
    ...
    if  playerRace==Race_Vaygr then
        ...
        Player_RestrictResearchOption(playerid, "CorvetteTech")
        Player_RestrictResearchOption(playerid, "FrigateTech")
        Player_RestrictResearchOption(playerid, "LanceBeams")
        Player_RestrictResearchOption(playerid, "PlasmaBombs")
        Player_RestrictResearchOption(playerid, "CorvetteLaser")
        Player_RestrictResearchOption(playerid, "PlatformHeavyMissiles")
        Player_RestrictResearchOption(playerid, "FrigateAssault")
        Player_RestrictResearchOption(playerid, "BattlecruiserIonWeapons")
        Player_RestrictResearchOption(playerid, "DestroyerGuns")
        Player_RestrictResearchOption(playerid, "HyperspaceGateTech")
        Player_RestrictResearchOption(playerid, "CarrierBUILDSPEEDUpgrade1")
        Player_RestrictResearchOption(playerid, "PlatformHealthUpgrade1")
        ...
        Player_RestrictBuildOption(playerid, "Vgr_Carrier")
        Player_RestrictBuildOption(playerid, "Vgr_CommandCorvette")
        Player_RestrictBuildOption(playerid, "Vgr_C_Module_Research")
        Player_RestrictBuildOption(playerid, "Vgr_MS_Module_Research")
    end
