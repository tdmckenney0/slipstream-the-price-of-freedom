...
-- left
paradeSlot("Corvette", { - 1045, - 2, 875}, {0, 0, 1}, { - 1, 0, 0}, 0)
...
-- paradeSlot("UNH_ResourceCollector", { - 927, 133, - 739}, {0, 0, 1}, { - 1, 0, 0}, 0)
-- paradeSlot("UNH_ResourceController", { - 927, 133, - 939}, {0, 0, 1}, { - 1, 0, 0}, 0)
...
--Left
-- paradeSlot("HWAT_REP_FTScout", {200, 110, 240}, {0, 0, 1}, {-1, 0, 0}, 60)
-- paradeSlot("HWAT_IMP_FTInterceptor", {200, 40, 240}, {0, 0, 1}, {-1, 0, 0}, 60)
-- paradeSlot("HWAT_UNH_FTInterceptor", {200, -30, 240}, {0, 0, 1}, {-1, 0, 0}, 60)
-- paradeSlot("HWAT_REP_FTInterceptor", {200, -100, 240}, {0, 0, 1}, {-1, 0, 0}, 60)
