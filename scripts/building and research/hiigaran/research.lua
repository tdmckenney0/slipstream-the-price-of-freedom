...
Family=1;
Ship=2;
research={{Name="InstaAdvancedFrigateTech",
RequiredResearch="",
...
Cost=5000,
Time=90,
DisplayedName="Nuclear Torpedo",
DisplayPriority=29,
Description="Allows Torpedo Frigates to use Nuclear Missils",
UpgradeType=Ability,
TargetType=Ship,
TargetName="Hgn_TorpedoFrigate",
UpgradeName="UseSpecialWeaponsInNormalAttack",
Icon=Icon_Ability,
ShortDisplayedName="Nuclear Torpedo"},
